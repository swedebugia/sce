...
** (White) Papers
+ [[http://arxiv.org/pdf/1506.02822v2.pdf][Reproducible and User-Controlled Software Environments in HPC with Guix]]
...
+ [[https://www.gnu.org/software/guix/][GNU's advanced distro and transactional package manager — GuixSD]] - a GNU linux distro which uses Guix as its package manager.
...
** Tips / Blogs
+ [[https://github.com/pjotrp/Guix-notes][pjotrp/guix-notes]] -  includes sections on:
  + on installation 
